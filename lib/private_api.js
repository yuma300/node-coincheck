...
var createPrivateApi = module.exports = function(api_key, secret_key, user_agent, nonce_func){
    ...
    var post_query = function(method, params){
    ...
    var get_query = function(method, params){
    ...
    var post_query_method = function(method){ return function(opt){
        var params = {};
        if(opt instanceof Object) Object.keys(opt).forEach(function(keys){ params[keys] = opt[keys] });
        return post_query(method, params) };
    };
    return {
        query : post_query,
        getBalance : function(){ return get_query('/accounts/balance', {}) },
        activeOrders : function(){ return get_query('/exchange/orders/opens', {}) },
        ...
        cancelOrder : function(order_id){
            return post_query('cancel_order', {order_id:order_id})
        },
    };
}
